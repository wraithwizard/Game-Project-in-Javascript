...
export class Running extends State{
    ...
    handleInput(input){
        ...
        //dust particle activation and shape-position
...
export class Falling extends State{
    ...
    enter(){       
        //we dont listen for any keys while we're falling
        this.game.player.frameX = 0;
        this.game.player.maxFrame = 6;
...
export class Rolling extends State{
    ...
    handleInput(input){        
        ...
        //fire particle activation and shape-position
